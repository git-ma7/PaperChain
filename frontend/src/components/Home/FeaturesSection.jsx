...
function FeaturesSection() {
    ...
    return (
        <div className='w-full mt-24 max-w-[1300px] mx-auto flex flex-col items-center justify-center homesection'>
            <div className='flex flex-col items-center justify-center px-3 gap-4'>
                <h1 className='text-center text-4xl md:text-5xl lg:text-6xl font-bold' style={{ fontFamily: "Dastin" }}>Revolutionary Features</h1>
                <p className='w-4/5 text-center text-base lg:text-xl'>Experience the future of document verification with cutting-edge blockchain technology</p>
            </div>
            <div className='w-full px-4 my-14'>
