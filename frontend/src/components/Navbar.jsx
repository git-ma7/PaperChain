...
function Navbar() {
    ...
    return (
        <div className={`fixed border border-black/20 rounded-lg bg-white/30 backdrop-blur-2xl z-50 max-w-[1300px] top-4 left-1/2 -translate-x-1/2 w-[91%] flex items-start md:items-center justify-between py-2 px-6 transition-all duration-200 ease-in-out ${isMenuOpen ? 'flex-col items-start h-[186px]' : 'h-[50px] md:h-fit'}`} style={{ fontFamily: "montserrat" }}>
