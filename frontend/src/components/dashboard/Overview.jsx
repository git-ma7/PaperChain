...
function Overview(props) {
    return (
        <div className='border border-black/10 bg-white/70 backdrop-blur-lg  w-full max-h-[250px] h-full rounded-md flex items-center justify-evenly'>
            <div className='w-full flex justify-evenly items-center p-6'>
                <div className='w-2/3 flex flex-col gap-2'>
                    <h3 className='text-black/70'>{props.title||"Total Documents"}</h3>
